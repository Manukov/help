...
Inversion Of Control (Инверсия управления) - это архитектурный подход, при котором объект не создает объекты зависимостей сам (через оператор new), а передает право на создание этих зависимостей и их внедрение другому компоненту, т. е. передает право управления.
